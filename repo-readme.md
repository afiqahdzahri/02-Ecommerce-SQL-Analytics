# E-commerce Sales DB & Analytics

![GitHub Repo stars](https://img.shields.io/github/stars/your-username/ecommerce-sql-analytics?style=flat-square) ![Language](https://img.shields.io/badge/language-Python-blue?style=flat-square) ![License](https://img.shields.io/badge/license-MIT-green?style=flat-square)

## Repository name
`ecommerce-sql-analytics`

## Description
Short summary: E-commerce Sales DB & Analytics. This repo is part of a multi-repo portfolio showcasing projects based on my Bachelor of Information Technology coursework.
...
git init
git add .
git commit -m "Initial commit - E-commerce Sales DB & Analytics"
gh repo create your-username/ecommerce-sql-analytics --public --source=. --remote=origin
